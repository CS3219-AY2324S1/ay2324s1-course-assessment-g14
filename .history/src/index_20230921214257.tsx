...
const fullHeightStyle: React.CSSProperties = {
  height: '100%', // Set height to 100% to fill the entire viewport height
};

const halfWidthStyle: React.CSSProperties = {
  width: '50%', // Set width to 50% for each side
};

const halfHeightStyle: React.CSSProperties = {
  height: '50%', // Set height to 50% for each side
};
...
function ProblemSolver() {
  ...
  return (
    <Container style={{ ...problemSolverStyle, ...fullHeightStyle }}>
      <Grid container spacing={2} style={fullHeightStyle}>
        <Grid item xs={12} md={6} style={{ ...halfWidthStyle, ...fullHeightStyle }}>
          <Paper elevation={3} style={{ padding: '16px', ...fullHeightStyle }}>
