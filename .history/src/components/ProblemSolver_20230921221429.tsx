  ...
  return (
    <Container
      sx={{
        ...
        minWidth: '100vw',
        paddingY: 4,
        backgroundColor: isDarkMode ? '#222' : '#fff', // Change background color based on dark mode
        ...
        <Grid item xs={12} md={6} sx={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
          <Paper elevation={3} sx={{ flex: 1, padding: 2 }}>
            ...
            <TextField
              ...
              sx={{ width: '50%' }} // Adjust width of the dropdown menu
            >
            ...
            <Button
              variant="contained"
              color={isDarkMode ? 'default' : 'primary'} // Change button color based on dark mode
