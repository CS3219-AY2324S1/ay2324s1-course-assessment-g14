  ...
  return (
    <Container
      sx={{
        ...
        color: isDarkMode ? 'white' : 'black', // Text color opposite to background
      }}
      
    >
      <Grid container spacing={2} sx={{flex: 1}}>
        <Grid item xs={12} md={6} sx={{ display: 'flex', flexDirection: 'column', flex: 1, padding: 2 }}>
        <Paper elevation={3} sx={{ flex: 1, display: 'flex', flexDirection: 'column', padding: 2, backgroundColor: isDarkMode ? 'darkgray' : 'white' }}>
        ...
        <Paper elevation={3} sx={{ flex: 1, padding: 2, display: 'flex', flexDirection: 'column', backgroundColor: isDarkMode ? 'darkgray' : 'white' }}>
